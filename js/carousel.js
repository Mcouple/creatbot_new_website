(function (window, undefined) {
  ...
  Carousel.prototype = {
    ...
    certainStyle: function () {
      ...
      this.offsetDistance = this.offsetDistance || this.availSize / (this.cardsNum+1.5);
    ...
    dynamicStyle: function (offsetIndex, offsetIndexAbs, reset) {
      ...
      if(offsetIndexAbs==0){
        this.cssObj.backgroundColor='rgba(247,249,251,1.0)';
      }
      else{
        this.cssObj.backgroundColor='#e9e9e9';
      }
    },
